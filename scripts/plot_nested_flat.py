...
filename='bench_nested_flat'

size = "xx-large"

xlabel = ['column size 16', 'column size 32', ]
xlabel = ['column size 16', 'column size 32', 'column size 64',]
...
legends = ['flat matrix', 'nested matrix']
# legends = list(d.keys())
print(d.keys()) 
...
plt.xticks([  x + 0.5 * barWidth for x in xss[0] ], list(xlabel), fontsize=size,)
