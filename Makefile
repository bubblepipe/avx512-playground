...
CFLAGS=-O3 -march=native -I src/ -fno-omit-frame-pointer -std=c++11 -Wno-format 
...
$(TARGET):
	$(CC) $(CFLAGS) src/bench_mat/$@.cpp -o $(OUT)$@ $(INC) 
...
flat-test-fma: flat-test
	...
	./build/flat-test --benchmark_filter=bench_mat_flat/fma_manual/8/16 > /dev/null 2>&1
